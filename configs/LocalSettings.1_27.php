...
$wgReadOnly = 'MAINTENANCE MODE: Database updates in progress, wiki is read-only.';
...
# Wikimedia-hosted, extension.json-based
...
# Semantic MediaWiki related extensions (Work in progress)
wfLoadExtension( 'SemanticMediaWiki' );
wfLoadExtension( 'SemanticResultFormats' );
enableSemantics('localhost');

# Deprecated extensions
require_once "$IP/extensions/StringFunctionsEscaped/StringFunctionsEscaped.php"; // not maintained
# Replaced extensions
// wfLoadExtension( 'DynamicPageList' ); // replaced with "intersection"
// wfLoadExtension( 'SemanticForms' ); replaced by PageForms
# Incompatible extensions
// wfLoadExtension( 'LocalisationUpdate' ); // Depricated!!
// wfLoadExtension( 'Validator' ); // Depricated!!
