...
Please refer to the [PHP_ERROR_REPORTING.md](./docs/PHP_ERROR_REPORTING.md) document for information about PHP error reporting configuration and handling deprecation warnings in production.
...
- **Important**: Set `MW_PHP_DEBUG=false` in production to hide PHP deprecation warnings and notices. See [PHP_ERROR_REPORTING.md](./docs/PHP_ERROR_REPORTING.md) for details.
